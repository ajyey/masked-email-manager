...
const PermanentlyDeleteButton: React.FC<PermanentlyDeleteButtonProps> = ({
  ...
  return (
    <div className="inline-flex items-center justify-center mt-2">
      <button
        onClick={onClick}
        className="text-white text-sm px-3 py-1 rounded-sm hover:bg-red-500 bg-red-600/[0.75] focus:outline-hidden focus:ring-4 focus:ring-blue-3 inline-flex items-center"
      >
