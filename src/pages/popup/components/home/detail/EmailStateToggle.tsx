...
const EmailStateToggle: React.FC<EmailStateToggleProps> = ({
  ...
  return (
    ...
    //     />
    //
    //     <span className="absolute inset-y-0 start-0 z-10 m-0.5 inline-flex h-6 w-6 items-center justify-center rounded-full bg-white text-gray-400 transition-all peer-checked:start-6 peer-checked:text-green-600">
    //       <svg
    //         data-unchecked-icon
    //         xmlns="http://www.w3.org/2000/svg"
    //         fill="none"
